...
class Writer:
    ...
    def print_info_eval(self, info):
        message = 'Epoch: {}/{}, Duration: {:.3f}s, Eval Loss: {:.4f}' \
                .format(info['current_epoch'], info['epochs'], info['t_duration'], info['eval_loss'])
        with open(self.log_file, 'a') as log_file:
            log_file.write('{:s}\n'.format(message))
        # print(message)
    ...
    def print_info_test(self, info):
        message = 'Epoch: {}/{}, Duration: {:.3f}s, Test Loss: {:.4f}' \
                .format(info['current_epoch'], info['epochs'], info['t_duration'], info['test_loss'])
        with open(self.log_file, 'a') as log_file:
            log_file.write('{:s}\n'.format(message))
        # print(message)
    ...
    def print_step_eval(self, info):
        message = 'Epoch: {}, Total_step: {}, Duration: {:.3f}s, Eval Loss: {:.4f}, Lr: {:.6f}' \
            .format(info['epoch'], info['total_step'], info['step_duration'], info['eval_loss'], info['lr'])
        with open(self.log_file, 'a') as log_file:
            log_file.write('{:s}\n'.format(message))
        # print(message)

    def print_step_test(self, info):
        message = 'Epoch: {}, Total_step: {}, Duration: {:.3f}s, Test Loss: {:.4f}, Lr: {:.6f}' \
            .format(info['epoch'], info['total_step'], info['step_duration'], info['test_loss'], info['lr'])
        with open(self.log_file, 'a') as log_file:
            log_file.write('{:s}\n'.format(message))
