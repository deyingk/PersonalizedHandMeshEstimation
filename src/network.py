...
def make_linear_layers_with_dropout(feat_dims, dropout_prob=0.5, relu_final=False):
    layers = []
...
class IKNet(nn.Module):
    def __init__(self, input_c=63, output_c=10, hidden_layers=[256, 512, 1024, 1024, 512, 256], dropout_prob=0.0):
        super().__init__()
        layers = [input_c] + list(hidden_layers) + [output_c]
        self.mlp = make_linear_layers_with_dropout(layers, dropout_prob=dropout_prob, relu_final=False)
