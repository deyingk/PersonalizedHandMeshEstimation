...
if __name__ == '__main__':
    ...
    args.model = 'mano_based_model_iterative_pose_without_gt_shape_with_conf'
    ...
    args.batch_size = 32
    args.model_dir = 'out/dex_ycb/reproduce_train_conf_branch'
    test_or_val = 'test'
    ...
    save_dir = osp.join(args.model_dir, test_or_val)
