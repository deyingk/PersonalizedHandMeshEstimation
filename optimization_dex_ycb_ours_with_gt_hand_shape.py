...
experiment_name = 'reproduce_ours_with_gt_hand_shape_and_optimization'
if_save = False
...
with_gt_shape = True
with_calibrated_shape = False
with_calibrated_shape_directly_from_beta = False
with_calibrated_shape_from_mano_baseline_mesh = False
with_baseline_pred_shape = False
with_calibrated_shape_from_mano_baseline_confidence = False
with_boukhayma = False
assert sum((with_gt_shape, with_calibrated_shape, with_calibrated_shape_directly_from_beta, with_calibrated_shape_from_mano_baseline_mesh,with_baseline_pred_shape, 
            with_calibrated_shape_from_mano_baseline_confidence, with_boukhayma)) == 1
...
if with_gt_shape:
    ...
    pass
elif with_calibrated_shape_from_mano_baseline_mesh:
    pass
elif with_calibrated_shape_from_mano_baseline_confidence:
    pass
elif with_boukhayma:
    pass
